<template>
    <nav class="navbar main-nav flex-row align-items-md-center" type="" effect="light" expand>
        ...
        <li class="nav-item">
          <a
            class="nav-link"
            href="https://github.com/creativetimofficial/vue-black-dashboard-laravel/issues"
            target="_blank"
            >Support</a
          >
        </li>
        <li class="nav-item">
            <a class="nav-link" href="https://www.creative-tim.com/product/vue-black-dashboard-laravel">Download now</a>
          </li>
          <!-- <li class="nav-item">
